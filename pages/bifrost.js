	...
	return (
		<div className="bifrost__main">
			...
			<div className="bifrost__main-note">
				<div className="bifrost__main-ph">
					<Image src={arjun} alt="arjun" height="400px" width="400px" />
				</div>
			...
			<div className="bifrost__main-note-2">
				<div className="bifrost__main-note-box-2">
					<h1 className="bifrost__main-note-heading-2">About Bifröst</h1>
					<p className="bifrost__main-note-p-2">
